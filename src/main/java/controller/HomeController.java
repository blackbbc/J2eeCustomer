...
public class HomeController {
    ...
    public ResponseEntity<Map<String, Object>> getLogin(
        ...
        if (user == null) {
            ...
            headers.add("Set-Cookie", "loginUid="+loginUid+"; expires=Sun, 20-Jun-2017 10:42:28 GMT; path=/");
            headers.add("Set-Cookie", "loginKey="+loginKey+"; expires=Sun, 20-Jun-2017 10:42:28 GMT; path=/");
            result.put("Code", 0);
            result.put("Msg", "操作成功");
